...
#' @return 
#' Desciptive tables for selected variables, median (min-max) for numeric variable, 
#' n(\%) for characteristic variables. ANOVA for numeric variables with normality 
#' assumption; Wilcoxon test for non-parametric variable and two groups; Kruiskal 
#' test for more than two groups (excluding missing group level); Chi-square test 
#' and Fisher\'s exact test for categorical variables (excluding missing levels, 
#' both variable and group)
